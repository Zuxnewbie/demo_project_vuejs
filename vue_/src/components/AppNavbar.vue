        ...
        <div class="top-info ps-2">
          <small class="me-3"
            ...
            <a href="#" class="text-white"
              >12 Trịnh Đình Thảo, P.Tây Thạnh, Q.Tân Phú, TP.HCM</a
            ></small
          >
          <small class="me-3"
            ><i class="fas fa-envelope me-2 text-secondary"></i
            ><a href="#" class="text-white">cdcntt@stu.edu.vn</a></small
          >
        </div>
      </div>
    </div>
        ...
        <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
          <div class="navbar-nav mx-auto">
            ...
            <a
              ...
              >Log out</a
            >
            <span v-if="isLoggedIn" class="nav-item nav-link"
              >Hello, {{ userName }}</span
            >
            <span v-if="isAdmin" class="nav-item nav-link">Hello, Admin</span>
          </div>
...
export default {
  ...
  computed: {
    ...
    isNameAdmin() {
      return this.$store.state.admin ? this.$store.state.admin.name : null;
    },
  },
  methods: {
    async logout() {
